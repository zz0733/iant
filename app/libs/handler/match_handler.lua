...
local update_match_doc = function ( doc, hits )
    ...
    for _,v in ipairs(hits) do
        ...
        log(ERR,"update_match_doc[".. doc._id .."],title["..cur_title .."]vs["..link_title.."]("..tostring(v._score)..")code[".. cur_code .."],year["..cur_year .."]vs[" .. link_year .."],link["..start_mills..","..tostring(end_mills).."],issued["..min_cur_issued..","..max_cur_issued.."]")
...
function _M.build_similars (hits )
    if not hits then
        return
    end
    for _,v in ipairs(hits) do
